...
MapGroup_FastShip:
	...
	map VermilionPort, TILESET_PORT, ROUTE, LANDMARK_OLIVINE_CITY, MUSIC_VERMILION_CITY, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	...
	map VermilionPortPassage, TILESET_UNDERGROUND, INDOOR, LANDMARK_OLIVINE_CITY, MUSIC_VERMILION_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
